...
function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      ...
      <div className="relative hidden overflow-hidden lg:flex lg:w-[45%] lg:flex-col lg:justify-between bg-gradient-to-br from-[#282828] via-[#1a1a1a] to-[#0F0F0F] p-12">

        {/* Decorative blobs */}
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -right-24 -top-24 h-80 w-80 rounded-full bg-red-500/20 blur-3xl" />
          <div className="absolute -bottom-24 -left-12 h-72 w-72 rounded-full bg-red-600/20 blur-3xl" />
          <div className="absolute left-1/2 top-1/2 h-48 w-48 -translate-x-1/2 -translate-y-1/2 rounded-full bg-red-400/10 blur-2xl" />
        </div>
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="mt-4 max-w-xs text-base leading-relaxed text-[#AAAAAA]">
        ...
        <div className="relative z-10">
          <p className="text-xs text-[#606060]">Internal tool — authorized personnel only</p>
        </div>
      </div>

      {/* ── Right login panel ── */}
      <div className="flex flex-1 flex-col items-center justify-center bg-yt-bg px-6 py-12">

        {/* Mobile: app logo */}
        <div className="mb-10 flex flex-col items-center text-center lg:hidden">
          <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-yt-red shadow-xl shadow-yt-red/30">
        ...
        <div className="w-full max-w-[360px]">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-yt-border bg-yt-card px-5 py-3.5 text-sm font-medium text-yt-text shadow-sm transition-all duration-200 hover:border-yt-text-secondary hover:shadow-md active:scale-[0.98]"
          >
            <GoogleIcon />
            Continue with Google
          </button>

          <p className="mt-6 text-center text-xs leading-relaxed text-yt-text-secondary">
